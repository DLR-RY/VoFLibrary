...
-------------------------------------------------------------------------------
              ...
              Modified work | Copyright (C) 2018 DLR
-------------------------------------------------------------------------------
License
...
Description
    Solver derived from compressibleInterFoam for 2 compressible, non-isothermal
    immiscible fluids using the iso-advector phase-fraction based interface
    capturing approach. The momentum and other fluid properties are of the "mixture"
