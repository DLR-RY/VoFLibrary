...
//    cutCellImpFunc cutCell(mesh,f,func); // changes f
...
// note: centre has to be in the correct position
    ...
    vector centre = initAlphaFieldDict.lookup("centre");
//    scalar radius = readScalar(initAlphaFieldDict.lookup("radius"));
    ...
    bool twoDim = (functionType == "functionDisc");
