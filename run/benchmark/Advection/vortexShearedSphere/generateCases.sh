...
schemeList=(plicRDF) # isoAlpha plicRDF 
...
wclean baseCase/generateU
wmake  baseCase/generateU
...
do
    ...
    then 
        ...
        then
		            ...
		            initAlphaField -case $caseDir > $caseDir/logs/setAlphaField.log 2>&1
		            generateU -case $caseDir > $caseDir/logs/generateU.log 2>&1
		elif [ "$meshType" = "poly" ]
		then
			nz=${NzList[$n]}
